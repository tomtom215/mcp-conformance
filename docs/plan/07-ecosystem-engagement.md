...
Ordering follows credibility economics: small, obviously-correct contributions (2, 3, 11) earn
the standing that large ones (1) require. Three items (3, 9's `enumNames` half, 10) have now
been resolved or obsoleted upstream *before* we filed — good for the ecosystem, and the
reason M4's "merged PR" line stays open while the engagement itself is demonstrably working.
