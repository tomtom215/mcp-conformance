...
```text
per revision:
  2025-11-25: 16 pass, 0 fail, 0 warn, 88 excluded, 0 unsupported, 14 not applicable, 22 not observed — verdict pass
  2026-07-28: 13 pass, 8 fail, 0 warn, 148 excluded, 0 unsupported, 0 not applicable, 103 not observed — verdict fail
...
- Five committed captures — a conforming session over each transport, a *probe*
  ...
  evidence **109 of the 124 judgeable clauses** between them. What no capture
