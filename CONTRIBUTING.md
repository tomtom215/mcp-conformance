...
Gates 7–12, plus five structural checks — SPDX headers, the CI write-scope
inventory, the toolchain pin, cross-revision registry continuity, and the ecosystem
register's row shape — are exactly `cargo xtask gates`: they need nothing but a stable
